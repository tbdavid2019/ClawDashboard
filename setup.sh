...
do_uninstall() {
  ...
  echo ""
  echo "   ⚠️  Don't forget to clean up AI Agent memory!"
  echo "   告訴你的 AI Agent / Tell your AI Agent:"
  echo ""
  echo "   「請清除所有 ClawDashboard 相關的長期記憶："
  echo "     1. 刪除 memory/ 下所有 claw-dashboard 相關檔案"
  echo "     2. 從 MEMORY.md 移除 ClawDashboard 相關索引"
  echo "     3. 確認記憶已清理乾淨」"
  echo ""
